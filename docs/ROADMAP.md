...
| 3 | Repository and environments | Scaffold React and ASP.NET Core projects, establish Docker PostgreSQL, CI checks, and configuration conventions. |
| 4 | Identity and access | Implement registration, login/logout, roles, protected routes, and authorisation tests. |
...
| 8 | Staff operations | Implement search, filters, priority, assignment, and workflow status changes. |
| 9 | Administration | Implement user/role management, category management, and audit records. |
